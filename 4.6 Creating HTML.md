...
Let's look that up in MDN.
  ...
  ![the document.createElement MDN web docs page](https://wesbos.com/static/7edef6ea7807739d91fc51cc8b570c98/aa440/251.png "the document.createElement MDN web docs page")
...
That is because we haven't actually put it on the page yet, we just created it and it's living in what is called **memory** right now.
  ...
  ![browser console showing output of myParagrah as empty tag](https://wesbos.com/static/193bcc888429cbcfddd5d698188862af/aa440/252.png "browser console showing output of myParagrah as empty tag")
...
```
  ...
  ![browser console showing output of myParagrah with added class 'special'](https://wesbos.com/static/f697b0f6f70254aace2dfae5bad6228c/aa440/253.png "browser console showing output of myParagrah with added class 'special'")
...
It takes in one parameter, which is a child reference.
  ...
  ![the node.appendChild MDN web docs page](https://wesbos.com/static/98a0744b7df7e660409f1be42414ec0a/aa440/254.png "the node.appendChild MDN web docs page")

```
document.body.appendChild(myParagraph);
```

  ![rendered html showing p tag before the closing body tag](https://wesbos.com/static/813b6d95ad4ff7008efe7b0532e5b3e8/f1c64/255.png "rendered html showing p tag before the closing body tag")
...
```
  ...
  ![rendered webpage showing a paragrah above an image](https://wesbos.com/static/a95c377d72334e11e1fcab87ac122534/d0c2f/257.png "rendered webpage showing a paragrah above an image")
...
## [](https://wesbos.com/javascript/01-the-basics/variables-and-statements#append-method)append method
...
You may come across the `.append()` method when searching for how to add an element to the DOM, which works very similarly to `createElement`. However, `append()` doesn't seem to be fully supported in Internet Explorer so Wes suggests holding off on using it.
  ...
  ![The .append method MDN web docs page](https://wesbos.com/static/dfd563c63c5d76ca751dcdf0858cf3a3/aa440/258.png "The .append method MDN web docs page")

## [](https://wesbos.com/javascript/01-the-basics/variables-and-statements#insertadjacentelement-method)insertAdjacentElement method
...
The difference is `insertAdjacentElement` is used to insert elements before, after and inside other elements.
  ...
  ![The .insertAdjacentElement method MDN web docs page](https://wesbos.com/static/c0743226a64239c8df9033953b5238ee/aa440/259.png "The .insertAdjacentElement method MDN web docs page")
...
If you try using `appendChild` as shown in the code above 👆, you should see that the heading is inserted after the image _(as shown below 👇)_ which is **not** what we want.
  ...
  ![rendered page showing a large heading below an image](https://wesbos.com/static/dd16a74befd70e03539140082edf08ce/35a31/260.png "rendered page showing a large heading below an image")
...
That will put the heading before the paragraph and image tag.
  ...
  ![rendered page showing a paragraph before an image](https://wesbos.com/static/447007afb8e39b0a4132aac4e3f3ab3d/99661/261.png "rendered page showing a paragraph before an image")
...
## [](https://wesbos.com/javascript/01-the-basics/variables-and-statements#generating-an-unordered-list)Generating An Unordered List
...
What that code will do is it will create a clone of the `li5` Node, and then insert that clone adjacently.
  ...
  ![rendered html showing a list with multiple nodes](https://wesbos.com/static/422445789d3544e4e0c7aa93a278c361/061c7/1447.png "rendered html showing a list with multiple nodes")
...
[Edit on Github](https://github.com/wesbos/wesbos/tree/master/src/javascript/04-the-dom/25-creating-html/25-creating-html.mdx)